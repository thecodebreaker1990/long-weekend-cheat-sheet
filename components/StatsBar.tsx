    ...
    <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4 shadow-sm">
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        ...
        <div className="flex flex-col">
          <div className="text-xs font-medium text-white/60">Weekends</div>
          <div className="mt-1 text-2xl font-semibold text-yellow-100">
            {stats.totalWeekends}
          </div>
          <div className="text-[11px] text-white/50">days</div>
        </div>

        {/* Holidays */}
        <div className="flex flex-col">
          <div className="text-xs font-medium text-white/60">Holidays</div>
